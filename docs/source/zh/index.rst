...
.. raw:: html
   ...
   <ul class="feature-list">
     <li>🚀 <span class="gradient-text">高性能</span>: 通过 cuDSS 实现 CUDA 加速求解</li>
...
.. raw:: html
   ...
   <ul class="feature-list">
     ...
     <li><span class="gradient-text">多后端支持</span>: <a href="https://docs.scipy.org/doc/scipy/reference/sparse.linalg.html">SciPy</a>、<a href="https://pytorch.org/">PyTorch原生</a>、<a href="https://docs.nvidia.com/cuda/cudss/">cuDSS</a></li>
...
- **GPU**: PyTorch原生 (CG, BiCGStab, GMRES, MINRES), cuDSS (LU, Cholesky, LDLT)
